...
{
    [Route("api/uebersicht_daten1/{action}", Name = "uebersicht_daten1Api")]
    public class uebersicht_daten1Controller : ApiController
    {
        ...
        private void PopulateModel(uebersicht_daten model, IDictionary values) {
            ...
            string PHOTO = nameof(uebersicht_daten.Photo);
